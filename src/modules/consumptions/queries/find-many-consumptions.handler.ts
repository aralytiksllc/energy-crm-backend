...
export class FindManyConsumptionsHandler
  implements IQueryHandler<FindManyConsumptionsQuery>
{
  constructor(private readonly prismaService: PrismaService) {}

  async execute(
    query: FindManyConsumptionsQuery,
  ): Promise<Paginate<ConsumptionFile>> {
